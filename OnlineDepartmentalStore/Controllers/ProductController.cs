...
using OnlineDepartmentalStore.Models;

namespace OnlineDepartmentalStore.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,CustomerName,Address,ContactNumber,Rice,Egg,Milk,Biscuit,Chocolate,IceCream,Dal,Sugar,Oil,Flour,Total")] Products products)
        {
            Price(products);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,CustomerName,Address,ContactNumber,Rice,Egg,Milk,Biscuit,Chocolate,IceCream,Dal,Sugar,Oil,Flour,Total")] Products products)
        {
            if (ModelState.IsValid)
            {
